        ...
        <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
                ...
                <div className='flex-1'>
                    ...
                    >
                        I am an experienced MERN STACK Developer with over a
                        decade of professional expertise in the field.
                        Throughout my career, I have had the previlege of collaborating
                    ...
                    <ul className='flex items-centers gap-3 sm:gap-5'>
